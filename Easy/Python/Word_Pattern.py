...
#Luckily, Python comes with a .split() function that allows us to split the words in a string and put them into a list. We can then iteratw through the list.
