class Solution:
    def lengthOfLastWord(self, s: str) -> int:
        new_string = s.rstrip().split() #rstrip() removes trailing whitspaces & split the string into seperate words (empty strings not included)
        ...
        return 0 #Return 0 if the list is blank (all emtpy strings)

#The approach to this problem is really easy when you consider the given Python built-in functions. Rsrip() removes any trailing whitespaces and ...
